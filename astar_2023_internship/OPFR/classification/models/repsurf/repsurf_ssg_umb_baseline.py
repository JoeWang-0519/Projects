...
class Model(nn.Module):
    def __init__(self, args):
        ...
        self.surface_constructor = UmbrellaSurfaceConstructor(args.group_size + 1, 10,
        ...
        self.sa2 = SurfaceAbstractionCD(npoint=128, radius=0.4, nsample=64, feat_channel=128,
                                        pos_channel=center_channel, mlp=[128, 128, 256], group_all=False,
                                        return_polar=args.return_polar, cuda=args.cuda_ops)
        self.sa3 = SurfaceAbstractionCD(npoint=None, radius=None, nsample=None, feat_channel=256,
