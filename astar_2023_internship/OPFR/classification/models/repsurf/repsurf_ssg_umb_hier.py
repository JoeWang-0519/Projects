...
from modules.repsurface_utils import SurfaceAbstractionCD, UmbrellaSurfaceConstructorV2
...
class Model(nn.Module):
    def __init__(self, args):
        ...
        self.surface_constructor = UmbrellaSurfaceConstructorV2(k1=args.group_size1+1, k2=args.group_size2, k3=args.group_size3+1,
                                                                in_channel=repsurf_channel, return_dist=args.return_dist,
                                                                aggr_type1=args.umb_pool1, aggr_type2=args.umb_pool2,
                                                              cuda=args.cuda_ops)
    ...
    def forward(self, points):
        ...
        # pfh: [B, 30, N]
       # normal = torch.cat([normal, pfh], dim=1)
