...
from modules.repsurface_utils import SurfaceAbstractionCD, PFHSurfaceConstructorV2
...
class Model(nn.Module):
    def __init__(self, args):
        ...
        self.surface_constructor = PFHSurfaceConstructorV2(k1=args.group_size1+1, k2=args.group_size2, k3=args.group_size3+1,
