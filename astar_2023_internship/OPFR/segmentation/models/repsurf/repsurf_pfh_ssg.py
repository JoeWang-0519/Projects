...
from modules.repsurface_utils import PFHSurfaceConstructor, SurfaceAbstractionCD, SurfaceFeaturePropagationCD
...
class Model(nn.Module):
    def __init__(self, args):
        ...
        repsurf_in_channel = 14
        repsurf_out_channel = 14
        ...
        self.surface_constructor = PFHSurfaceConstructor(args.group_size + 1, repsurf_in_channel, repsurf_out_channel)
