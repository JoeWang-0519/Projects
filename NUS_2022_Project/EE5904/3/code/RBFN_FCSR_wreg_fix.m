...
% 'fix' means we fix our choice of choosing center
function [w, record_random_centroid, std] = RBFN_FCSR_wreg_fix(X_train, target_train, center_num, regularization, centroid_idx)
...
% centroid_idx: the index of centroid in the X_train; 1 * number of
% centroids
...
% index of centroid -> centroid_idx
